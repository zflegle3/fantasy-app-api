...
console.log('~~~~~ This script populates data to the databse ~~~~~');
...
function createTeams(cb) {
  async.series([
      function(callback) {
          teamCreate("Putter Face", "No Manager", [players[0],players[5], players[10], players[15]], callback)
      },
      function(callback) {
          teamCreate("McGavin's Mulligans", "No Manager", [players[1],players[6], players[11], players[16]], callback)
      },
      function(callback) {
          teamCreate("Fore Guys One Cup", "No Manager", [players[2],players[7], players[12], players[17]], callback)
      },
      function(callback) {
          teamCreate("Weapons of Grass Destruction", "No Manager", [players[3],players[8], players[13], players[18]], callback)
      },
      function(callback) {
          teamCreate("Putt Stuff", "No Manager", [players[4],players[9], players[14], players[19]], callback)
      },
      ],
        // optional callback
        cb);
...
function createLeagueData(cb) {
  async.series([
      ...
      function(callback) {
          leagueCreate("LIV Laugh Love Golfers Association", "no admin", {schedule:[], teamCount:5, missCutScore: 1, rosterCut: 1, rosterSize: 4,}, teams, ["The LIV Laugh Love Golfers Association League has been created"], callback);
      },
